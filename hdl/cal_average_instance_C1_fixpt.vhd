...
ARCHITECTURE rtl OF cal_average_instance_C1_fixpt IS
  ...
  SIGNAL powerbot_1                       : unsigned(31 DOWNTO 0);  -- ufix32_En33
  SIGNAL tmp_17                           : unsigned(31 DOWNTO 0);  -- ufix32_En33
  ...
  SIGNAL csum0alt_re                      : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL csum0alt_im                      : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL p87csum0alt_sub_cast             : signed(31 DOWNTO 0);  -- int32
  SIGNAL p87csum0alt_sub_cast_1           : signed(31 DOWNTO 0);  -- int32
  SIGNAL ar_2                             : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL y_re_1                           : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL y_im_1                           : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL p84y_cast                        : signed(32 DOWNTO 0);  -- sfix33_En31
  SIGNAL p84y_cast_1                      : signed(32 DOWNTO 0);  -- sfix33_En31
  SIGNAL br_2                             : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL ai_2                             : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL bi_2                             : signed(31 DOWNTO 0);  -- sfix32_En31
  SIGNAL tmp_24                           : unsigned(31 DOWNTO 0);  -- ufix32_En33
  SIGNAL p81tmp_mul_temp                  : signed(63 DOWNTO 0);  -- sfix64_En62
  SIGNAL p81tmp_sub_cast                  : signed(64 DOWNTO 0);  -- sfix65_En62
  SIGNAL p81tmp_mul_temp_1                : signed(63 DOWNTO 0);  -- sfix64_En62
  SIGNAL p81tmp_sub_cast_1                : signed(64 DOWNTO 0);  -- sfix65_En62
  SIGNAL p81tmp_sub_temp                  : signed(64 DOWNTO 0);  -- sfix65_En62
  SIGNAL tmp_25                           : unsigned(31 DOWNTO 0);  -- ufix32_En33
  SIGNAL tmp_26                           : unsigned(31 DOWNTO 0);  -- ufix32_En33
  SIGNAL tmp_27                           : unsigned(31 DOWNTO 0);  -- ufix32_En33
  SIGNAL drift_FD_1                       : signed(31 DOWNTO 0);  -- sfix32_En5
  SIGNAL tmp_28                           : signed(31 DOWNTO 0);  -- sfix32_En5
  ...
  SIGNAL tmp_35                           : signed(31 DOWNTO 0);  -- sfix32_En5
  ...
  SIGNAL tmp_36                           : signed(31 DOWNTO 0);  -- sfix32_En5
  SIGNAL tmp_37                           : signed(31 DOWNTO 0);  -- sfix32_En5
  SIGNAL tmp_38                           : signed(31 DOWNTO 0);  -- sfix32_En5
...
BEGIN
  ...
  -- 'cal_average_instance_C1_fixpt:38' csum0alt = fi(sum0alt(calbin), 1, 32, 31, fm);
  -- 
  ...
  -- 'cal_average_instance_C1_fixpt:25' powerbot =fi(0, 0, 32, 33, fm);
  ...
  csum0alt_re <= tmp_re_18(hdl_sim_index_check(to_integer(p87csum0alt_sub_cast - 1), 0, 262143))(30 DOWNTO 0) & '0';
  p87csum0alt_sub_cast_1 <= signed(resize(calbin_unsigned, 32));
  csum0alt_im <= tmp_im_18(hdl_sim_index_check(to_integer(p87csum0alt_sub_cast_1 - 1), 0, 262143))(30 DOWNTO 0) & '0';
  ...
  tmp_24 <= unsigned(p81tmp_sub_temp(60 DOWNTO 29));
  ...
  -- 'cal_average_instance_C1_fixpt:26' drift_FD = fi(0, 1, 32, 5, fm);
  ...
  tmp_35 <= p61tmp_sub_temp(59 DOWNTO 28);
